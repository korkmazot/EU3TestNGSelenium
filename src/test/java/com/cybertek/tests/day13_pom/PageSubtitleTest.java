...
public class PageSubtitleTest extends TestBase {
    ...
    //Test Case ==>> Open Chrome Browser ==>> Verify that page subtitle is Quick Launchpad ==>>
    //Go to activities ==>> Calendar Events ==>> verify that page subtitle is Calendar Events
